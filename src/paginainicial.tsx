...
const dados: Item[] = [
    {id: "1" , nome:"ੈ♡˳𝘼𝙢𝙚𝙧𝙞𝙘𝙖𝙣 𝘾𝙤𝙛𝙛𝙚𝙚" , preco:"R$3,70" , lista_ingredientes: "𝙘𝙖𝙛𝙚 𝙚𝙨𝙥𝙧𝙚𝙨𝙨𝙤, 𝙖𝙜𝙪𝙖 𝙦𝙪𝙚𝙣𝙩𝙚", image: require('./assets/images/caafe.png') },
    ...
    {id: "16", nome: "ੈ♡˳𝙠𝙞𝙩𝙩𝙚𝙣 𝙘𝙤𝙤𝙠𝙞𝙚", preco: "R$3,50", lista_ingredientes: "𝙨𝙤𝙧𝙫𝙚𝙩𝙚 𝙙𝙚 𝙜𝙖𝙩𝙤 𝙚𝙨𝙥𝙖𝙘𝙞𝙖𝙡, 𝙗𝙞𝙨𝙘𝙤𝙞𝙩𝙤 𝙞𝙣𝙩𝙚𝙧𝙜𝙖𝙡𝙖𝙩𝙞𝙘𝙤, 𝙡𝙞𝙦𝙪𝙞𝙙𝙤 𝙙𝙖 𝙛𝙚𝙡𝙞𝙘𝙞𝙙𝙖𝙙𝙚, 𝙥𝙤́ 𝙙𝙚 𝙙𝙤𝙥𝙖𝙢𝙞𝙣𝙖", image :require('./assets/images/gatinho.png')},
    {id: "17", nome: "ੈ♡˳𝘾𝙖𝙨𝙥𝙖 𝙙𝙚 𝙨𝙚𝙧𝙚𝙞𝙖", preco: "0,30(𝙪𝙣𝙞𝙙𝙖𝙙𝙚)", lista_ingredientes: "𝙖𝙘𝙪𝙢𝙪𝙡𝙤 𝙙𝙚 𝙖𝙜𝙪𝙖 𝙨𝙖𝙡𝙜𝙖𝙙𝙖 𝙚 𝙘𝙧𝙚𝙢𝙚 𝙙𝙚 𝙘𝙧𝙪𝙨𝙩𝙖𝙘𝙚𝙤𝙨", image :require('./assets/images/pipoca.png')},
    {id: "18", nome: "ੈ♡˳𝙛𝙖𝙞𝙧𝙮 𝙩𝙞𝙣𝙮 𝙝𝙤𝙪𝙨𝙚", preco: "R$17,22", lista_ingredientes: "𝙧𝙚𝙟𝙪𝙣𝙩𝙚,𝙘𝙞𝙢𝙚𝙣𝙩𝙤 𝙙𝙚 𝙘𝙝𝙤𝙘𝙤𝙡𝙖𝙩𝙚, 𝙩𝙚𝙡𝙝𝙖𝙙𝙤 𝙙𝙚 𝙝𝙞𝙗𝙞𝙨𝙘𝙤, 𝙥𝙚𝙞𝙙𝙤 𝙙𝙚 𝙛𝙖𝙙𝙖", image :require('./assets/images/minicasa.png')},
    {id: "19", nome: "ੈ♡˳𝘼𝙜𝙪𝙖 𝙙𝙚 𝙡𝙖𝙫𝙖𝙣𝙙𝙖", preco: "R$4,50", lista_ingredientes: "𝙖𝙜𝙪𝙖 𝙙𝙤 𝙡𝙖𝙜𝙤 𝙙𝙚 𝙡𝙖𝙜𝙧𝙞𝙢𝙖 𝙙𝙚 𝙜𝙞𝙜𝙖𝙣𝙩𝙚, 𝙡𝙖𝙫𝙖𝙣𝙙𝙖 𝙧𝙚𝙘𝙚́𝙢-𝙘𝙤𝙡𝙝𝙞𝙙𝙖", image :require('./assets/images/lavanda.png')},
    {id: "20", nome: "ੈ♡˳𝙎𝙪𝙩𝙞𝙖̃ 𝙙𝙚 𝙨𝙚𝙧𝙚𝙞𝙖", preco: "R$12,25", lista_ingredientes: "concha, alça", image :require('./assets/images/concha.png')},
];  
